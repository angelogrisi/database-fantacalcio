...
-- Block 9: intelligent schedule and opponent difficulty
CREATE TABLE IF NOT EXISTS schedule_difficulty (
  id INTEGER PRIMARY KEY,
  season_id INTEGER NOT NULL,
  club_id TEXT NOT NULL,
  horizon_matches INTEGER NOT NULL DEFAULT 5,
  attack_difficulty REAL,
  defence_difficulty REAL,
  overall_difficulty REAL,
  home_away_balance REAL,
...
-- Block 11: auction system
CREATE TABLE IF NOT EXISTS auction_values (
  id INTEGER PRIMARY KEY,
  player_id TEXT NOT NULL,
  season_id INTEGER NOT NULL,
  club_id TEXT NOT NULL,
  budget_500_value REAL,
  budget_1000_value REAL,
  value_tier TEXT,
  undervaluation_index REAL,
  overvaluation_risk REAL,
...
-- Block 12: season simulation summary
CREATE TABLE IF NOT EXISTS season_simulations (
  ...
  expected_appearances REAL,
  expected_goals REAL,
  expected_assists REAL,
  expected_fantasy_points REAL,
  floor_fantasy_points REAL,
  ceiling_fantasy_points REAL,
  breakout_probability REAL,
  flop_probability REAL,
  methodology_version TEXT NOT NULL DEFAULT 'block12-v1',
  generated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
  UNIQUE(player_id,season_id,club_id,methodology_version)
);

-- Block 13: dashboard-ready aggregates
...
-- Block 15: update and quality monitoring
...
-- Block 16: advanced predictive AI
CREATE TABLE IF NOT EXISTS ai_player_predictions (
  ...
  goal_probability REAL,
  assist_probability REAL,
  yellow_probability REAL,
  red_probability REAL,
  clean_sheet_probability REAL,
  explosion_index REAL,
  flop_index REAL,
  confidence REAL,
  explanation TEXT,
